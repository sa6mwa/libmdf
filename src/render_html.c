...
static const char *html_heading_span_size(int level)
{
    static const char *const sizes[] = {
        "",
        "font-size:22.799999999999997pt;",
        "font-size:19.200000000000003pt;",
        "font-size:15.600000000000001pt;",
        "font-size:12pt;",
        "font-size:12pt;",
        "font-size:12pt;"
    };
...
int html_write_open_link_grouped(mdf_impl *impl, mdf_sink *sink, const char *link, size_t link_len)
{
    ...
    if (mdf_write_cstr(&buf_sink, "<a href=\"") != 0 ||
        html_escape(&buf_sink, link, link_len) != 0 ||
...
static int html_write_heading_suffix(mdf_sink *sink, int level)
{
    static const char *const sizes[] = {
        "",
        "font-size:22.799999999999997pt;font-weight:700;--mdf-heading-indent:2ch;",
        "font-size:19.200000000000003pt;font-weight:700;--mdf-heading-indent:3ch;",
        "font-size:15.600000000000001pt;font-weight:700;--mdf-heading-indent:4ch;",
        "font-size:12pt;font-weight:700;--mdf-heading-indent:5ch;",
        "font-size:12pt;font-weight:700;--mdf-heading-indent:6ch;",
        "font-size:12pt;font-weight:700;--mdf-heading-indent:7ch;"
    };
