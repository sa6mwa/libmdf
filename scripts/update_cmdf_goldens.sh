...
write_case comprehensive.ansi.styled.w80 --osc8 on -w 80
write_case comprehensive.ansi.boring.w80 --osc8 on --boring -w 80
write_case comprehensive.ansi.boring.w80.margin-l4-r6 --osc8 on --boring -w 80 --margin-left 4 --margin-right 6
write_case comprehensive.ansi.styled.w40.margin-l2-r3 --osc8 on -w 40 --margin-left 2 --margin-right 3
