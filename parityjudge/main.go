...
func normalizeReferenceHTML(out []byte) []byte {
	...
	repls := []struct {
		...
		{"font-size:22.799999999999997pt;", "font-size:32pt;"},
		{"font-size:19.200000000000003pt;", "font-size:22pt;"},
		{"font-size:15.600000000000001pt;", "font-size:15pt;"},
		{"font-size:12pt;font-weight:700;--mdf-heading-indent:5ch;", "font-size:14pt;font-weight:700;--mdf-heading-indent:5ch;"},
		{"font-size:12pt;font-weight:700;--mdf-heading-indent:6ch;", "font-size:13pt;font-weight:700;--mdf-heading-indent:6ch;"},
		{"font-size:12pt;font-weight:700;--mdf-heading-indent:7ch;", "font-size:12.5pt;font-weight:700;--mdf-heading-indent:7ch;"},
	}
...
func render(mode string, data []byte, chunk int, width int, opts parityOptions, tracePath string, stderr io.Writer) ([]byte, error) {
	...
	case "html":
		...
		return normalizeReferenceHTML(out.Bytes()), err
	case "tokens":
		theme, err := themeByName(opts.theme, opts.boring)
		if err != nil {
			return nil, err
...
func renderReference(mode string, data []byte, chunk int, width int, opts parityOptions, trace bool) ([]byte, []byte, error) {
	...
	case "html":
		...
		return normalizeReferenceHTML(out.Bytes()), traceBuf.Bytes(), err
	default:
